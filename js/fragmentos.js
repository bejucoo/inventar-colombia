...
// Abrir y cerrar introducción e instrucciones.
(() => {
...
// Abrir el dialog de introducción cuando se entre a la página.
(() => {
	const openButton_introduccion = document.getElementById("openDialog_introduccion");
...
// Obtener categorías sin repetir del archivo de fragmentos.
...
const addFullText = () => {
	...
	setTimeout(() => {
		...
		if (mdElm.rendered === "remote") {
			...
			console.error("Posible error cargando el cuerpo de texto. Seleccionar de nuevo para recargar.");
		}
	}, 500);
}